		...
		if (copyURLMenuItem == null) {
			...
			copyURLMenuItem.addActionListener(new ActionListener() {
				public void actionPerformed(final ActionEvent e) {
					...
					ClipboardUtils.defaultClipboard
							.setClipboardContents(fileUrls.toString());
				}
			});
						...
						public void run() {
							try {
								...
								if (selectedFiles.length == 1) {
									message
											.append("You are about to delete this file:\n\n");
								} else {
									message
											.append("You are about to delete these files:\n\n");
								}
								...
								int answer = JOptionPane.showConfirmDialog(
										SiteFileChooserPanel.this, message
												.toString(), "Kill Jobs",
								...
								FileManagerDeleteHelpers.deleteFiles(em
										.getServiceInterface(),
					...
					new Thread() {
						public void run() {
							try {
								...
								pd.setFile((GrisuFileObject) list
										.getSelectedValue());
								setBusy(false);
								pd.setVisible(true);
