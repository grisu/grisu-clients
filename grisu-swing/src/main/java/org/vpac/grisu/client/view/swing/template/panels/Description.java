...
/**
 * This is only used by the "Common" module to store a description of the
 * current job on the grisu core service. It's not included in the jsdl (because
 * it's not required for a job to run).
 * 
...
public class Description extends JPanel implements TemplateNodePanel {
	...
	static final Logger myLogger = Logger
			.getLogger(Description.class.getName());
	...
	public Description() {
		...
		add(getIncludeNotesOnCheckBox(), new CellConstraints(2, 2,
				CellConstraints.LEFT, CellConstraints.TOP));
		add(getScrollPane(), new CellConstraints(2, 6, 3, 1,
				CellConstraints.FILL, CellConstraints.FILL));
		add(getErrorLabel(), new CellConstraints(2, 4, 3, 1,
