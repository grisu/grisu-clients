...
public class GrisuAboutDialog extends JDialog {
	...
	protected JPanel getPanel() {
		if (panel == null) {
			...
			panel.add(getScrollPane(), new CellConstraints(2, 6, 3, 1, CellConstraints.FILL, CellConstraints.FILL));
		}
		return panel;
	}
	/**
	...
	protected JLabel getLabel() {
		if (label == null) {
			label = new JLabel();
			label.setIcon(SwingResourceManager.getIcon(GrisuAboutDialog.class, "/images/ARCS_LogoTag_even_smaller.jpg"));
		}
		return label;
	}
	/**
