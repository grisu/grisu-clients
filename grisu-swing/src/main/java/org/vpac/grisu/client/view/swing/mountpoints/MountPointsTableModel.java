...
public class MountPointsTableModel extends AbstractTableModel {
	...
	public static final String[] columnNames = new String[] { "Alias", "Url",
			"VO", "Automounted" };

	// private Map<MountPoint, Object[]> mountpoints = new TreeMap<MountPoint,
	// Object[]>();
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case FQAN_INDEX:
			...
			if (fqan == null)
				...
				return fqan;
		case AUTOMOUNT_INDEX:
			return mp.isAutomaticallyMounted();
		}
