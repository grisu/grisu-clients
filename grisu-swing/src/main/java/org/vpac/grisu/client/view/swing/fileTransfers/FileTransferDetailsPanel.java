...
public class FileTransferDetailsPanel extends JPanel implements
	...
	public FileTransferDetailsPanel(FileTransferDetailsPanelHolder parent) {
		...
		setLayout(new FormLayout(new ColumnSpec[] {
				...
				FormFactory.RELATED_GAP_ROWSPEC, RowSpec.decode("16dlu"),
				FormFactory.RELATED_GAP_ROWSPEC, FormFactory.DEFAULT_ROWSPEC,
				FormFactory.RELATED_GAP_ROWSPEC }));
		add(getScrollPane(), new CellConstraints(2, 2, CellConstraints.FILL,
				CellConstraints.FILL));
		add(getProgressBar(), new CellConstraints(2, 4, CellConstraints.FILL,
				CellConstraints.FILL));
		add(getCancelButton(), new CellConstraints(2, 6,
