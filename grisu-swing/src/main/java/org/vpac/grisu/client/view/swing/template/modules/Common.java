...
public class Common extends AbstractModulePanel implements ValueListener {
	...
	protected void initialize() throws ModuleException {
		...
		String useMds = ((org.vpac.grisu.client.model.template.modules.Common)templateModule).getConfiguration().get(USE_MDS_CONFIG_OPTION_KEY);
			
		if ( useMds == null || TemplateHelperUtils.NO_VALUE.equals(useMds) ) {
			((org.vpac.grisu.client.model.template.modules.Common)templateModule).useMds(true);
		} else {
			((org.vpac.grisu.client.model.template.modules.Common)templateModule).useMds(false);
		}
		
		// initialize the Common TemplateModule with the application
		((org.vpac.grisu.client.model.template.modules.Common)templateModule).setApplication(template.getApplicationName());
		((org.vpac.grisu.client.model.template.modules.Common)templateModule).setDefaultVO();
		try {
		...
		getQueuePanel().initialize((org.vpac.grisu.client.model.template.modules.Common)templateModule);
