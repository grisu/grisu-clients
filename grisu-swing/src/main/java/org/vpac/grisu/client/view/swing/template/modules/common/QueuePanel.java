...
public class QueuePanel extends JPanel implements FqanListener,
		MountPointsListener {
	...
	// private DefaultTemplateNodeValueSetter executionFsSetter = new
	// DefaultTemplateNodeValueSetter();
	// private DefaultTemplateNodeValueSetter moduleSetter = new
	// DefaultTemplateNodeValueSetter();
	...
	public QueuePanel() {
		super();
		setBorder(new TitledBorder(null, "Submission details",
		...
		layout = new FormLayout(new ColumnSpec[] {
				...
				RowSpec.decode("8dlu"), FormFactory.RELATED_GAP_ROWSPEC,
				FormFactory.DEFAULT_ROWSPEC, FormFactory.RELATED_GAP_ROWSPEC,
				FormFactory.DEFAULT_ROWSPEC, RowSpec.decode("64dlu"),
	...
	protected JPanel getModulePanel() {
		if (modulePanel == null) {
			...
			modulePanel.setBorder(new TitledBorder(null, "Module",
					TitledBorder.DEFAULT_JUSTIFICATION,
					TitledBorder.DEFAULT_POSITION, null, null));
			modulePanel.setLayout(new FormLayout(new ColumnSpec[] {
					FormFactory.RELATED_GAP_COLSPEC,
					ColumnSpec.decode("63dlu:grow(1.0)"),
					FormFactory.RELATED_GAP_COLSPEC }, new RowSpec[] {
					RowSpec.decode("8dlu"), RowSpec.decode("4dlu"),
					FormFactory.DEFAULT_ROWSPEC,
					FormFactory.RELATED_GAP_ROWSPEC }));
			modulePanel.setName("panel");
			modulePanel.add(getTextField(), new CellConstraints(2, 3,
					CellConstraints.FILL, CellConstraints.BOTTOM));
			modulePanel.add(getPleaseSpecifyTheLabel(), new CellConstraints(2,
					1, CellConstraints.RIGHT, CellConstraints.BOTTOM));
		}
		return modulePanel;
	}
	...
	protected JPanel getVersionPanel() {
		if (versionPanel == null) {
			...
			versionPanel.setLayout(new FormLayout(new ColumnSpec[] {
					...
					FormFactory.RELATED_GAP_COLSPEC }, new RowSpec[] {
					new RowSpec("12dlu"), FormFactory.RELATED_GAP_ROWSPEC,
	...
	public void initialize(Common commonGenericModule) {
		...
		this.commonGenericModule.getTemplate().getEnvironmentManager()
				.addFqanListener(this);
		this.commonGenericModule.getTemplate().getEnvironmentManager()
				.addMountPointListener(this);
