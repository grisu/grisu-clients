...
public interface TemplateNodePanel extends TemplateNodeListener,
		TemplateNodeValueSetter {

	// public static final String COSTUM_USER_INPUT_DISABLED = "locked";

	/**
	 * Adds a listener that gets notified when the value of this panel is
	 * changed
	 * 
	 * @param v
	 *            the listener to add
	...
	/**
	 * Resets the panel to it's original state. Can also be used to store user
	 * input into history file.
	 */
	public void reset();
	 ...
	 *             if something goes wrong (i.e. TemplateNode is not compatible
	 *             with panel)
	 */
