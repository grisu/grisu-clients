...
public class JobDirectoryFileObjectCellRenderer implements ListCellRenderer {
	...
	public Component getListCellRendererComponent(JList list, Object value,
		...
		if (!fs.currentDirectoryIsOnRoot() && index == 0) {
			...
			if ("stdout.txt".equals(name) || "stderr.txt".equals(name)) {
				label.setFont(label.getFont().deriveFont(Font.BOLD));

				if ("stderr.txt".equals(name) && file.getSize(false) > 0) {
