...
public class MemoryInputPanel extends JPanel implements TemplateNodePanel {
	...
	static final Logger myLogger = Logger.getLogger(MemoryInputPanel.class
			.getName());
	...
	public static String[] DEFAULT_MEMORY = new String[] { "1024", "2048",
			"4096", "8192", "16384" };
	...
	public MemoryInputPanel() {
		super();
		setBorder(new TitledBorder(null, "Memory",
		...
		setLayout(new FormLayout(new ColumnSpec[] {
				...
				RowSpec.decode("4dlu"), FormFactory.DEFAULT_ROWSPEC,
				FormFactory.RELATED_GAP_ROWSPEC }));
		add(getMinMemoryinLabel(), new CellConstraints(2, 2,
	...
	public void setTemplateNode(TemplateNode node)
		...
		fireSitePanelEvent((String) memComboBox.getSelectedItem());
