	...
	public void addLocalTemplate() {
		...
		if (file.exists()) {
			try {
				...
				String localTemplateName = templateManager.addLocalTemplate(
						file, true);
				...
				SubmissionPanel.this.templateManager.addLocalTemplate(file,
						true);
			...
			JOptionPane.showMessageDialog(SubmissionPanel.this, "File "
					+ file.toString() + " doesn't exist. Can't copy it...",
		...
		if (refreshRemoteTemplate == null) {
			...
			refreshRemoteTemplate.addActionListener(new ActionListener() {
				public void actionPerformed(final ActionEvent e) {
					...
					String templateName = (String) (getRemoteList()
							.getSelectedValue());
