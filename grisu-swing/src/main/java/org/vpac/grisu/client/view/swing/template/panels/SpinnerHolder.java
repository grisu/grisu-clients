...
public class SpinnerHolder extends JPanel implements ComponentHolder {
	 ...
	 * Create the panel
	 */
	public SpinnerHolder(AbstractInputPanel parent, int min, int max, int defaultValue, int delta) {
		super();
		...
		this.spinnerModel = new SpinnerNumberModel(defaultValue, min, max, delta);
	...
	public void setComponentField(String value) {
		try {
			...
			myLogger.warn("Couldn't set value of spinner to: "+value+". "+e.getLocalizedMessage());
		}
	}
	/**
	 * @return
