...
/**
 * This interface specifies the capabilties of a panel that is able to preview certain files.
 * 
...
//			if ( extensionInQuestion.toLowerCase().equals(extension.toLowerCase()) ) {
//				return true;
//			}
