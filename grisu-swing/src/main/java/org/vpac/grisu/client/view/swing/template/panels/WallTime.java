...
public class WallTime extends JPanel implements TemplateNodePanel{
	...
	static final Logger myLogger = Logger.getLogger(WallTime.class
			.getName());
	
	private JLabel errorLabel;
	private TemplateNode templateNode = null;
	
	public static final String[] DAYS_DEFAULTS = new String[]{"0","1","2","7","14","21"};
	public static final String[] HOURS_DEFAULTS = new String[]{"0","1","6","12","18"};
	public static final String[] MINUTES_DEFAULTS = new String[]{"0","15","30","45"};
	...
	public WallTime() {
		super();
		setBorder(new TitledBorder(null, "Walltime", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
		setLayout(new FormLayout(
			...
			new RowSpec[] {
				...
				FormFactory.DEFAULT_ROWSPEC,
				FormFactory.RELATED_GAP_ROWSPEC}));
		add(getDaysLabel(), new CellConstraints(2, 3, CellConstraints.DEFAULT, CellConstraints.BOTTOM));
		add(getHoursLabel(), new CellConstraints(4, 3, CellConstraints.DEFAULT, CellConstraints.BOTTOM));
		add(getMinutesLabel(), new CellConstraints(6, 3, CellConstraints.DEFAULT, CellConstraints.BOTTOM));
	...
	public long getWallTime() {
		...
		int days = Integer.parseInt((String)getDaysComboBox().getSelectedItem());
		int hours = Integer.parseInt((String)getHoursComboBox().getSelectedItem());
		int minutes = Integer.parseInt((String)getMinutesComboBox().getSelectedItem());
	...
	public void setTemplateNode(TemplateNode node) throws TemplateNodePanelException {
		...
		if ( defaultValue != null && ! "".equals(defaultValue) ) {
			try {
				...
				myLogger.warn("Couldn't set default walltime: "+e.getLocalizedMessage());
			}
		}
