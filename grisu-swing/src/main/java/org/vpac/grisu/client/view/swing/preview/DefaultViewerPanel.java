...
public class DefaultViewerPanel extends PreviewPanelInsert {
	...
	public DefaultViewerPanel() {
		...
		add(getBrowseButton(), new CellConstraints(4, 10, CellConstraints.LEFT,
				CellConstraints.TOP));
		add(getOpenButton(), new CellConstraints(6, 10));
		add(getLabel(), new CellConstraints(2, 11, 3, 1, CellConstraints.LEFT,
				CellConstraints.TOP));
			...
			browseButton.addActionListener(new ActionListener() {
				public void actionPerformed(final ActionEvent e) {
					...
					if (option != JFileChooser.CANCEL_OPTION) {
						...
						getApplicationPathTextField().setText(
								selected.getPath());
					}
				}
			});
	...
	public void setFileToPreview(GrisuFileObject file) {
		...
		if (lastIndex != -1) {
			...
			String defaultApplicationPath = ClientPropertiesManager
					.getDefaultExternalApplication(extension);
