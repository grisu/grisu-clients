...
/**
 * A wrapper class that tries to connect the existing {@link SiteFileChooserDialog} class
 * with the {@link FileChooserInterface} of the JMolEditor project.
 * 
 * @author Markus Binsteiner
 *
 */
public class JMolFileChooserImplWrapper implements FileChooserInterface, FileChooserParent {
