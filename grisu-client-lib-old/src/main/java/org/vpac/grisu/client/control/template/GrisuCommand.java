 ...
 * imagine 3 different kinds of commands: <li>
 * <ul>
 * a single job submission
 * </ul>
 * <ul>
 * an execution of one method of the grisu {@link ServiceInterface} (mostly the
 * filesystem related ones
 * </ul>
 * <ul>
 * a (client) local command
 * </ul>
 * </li>
 * 
...
public interface GrisuCommand {
	 ...
	 * 
	 * @param fqan
	 *            the fqan to use to execute this command
