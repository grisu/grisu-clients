...
public class ServiceInterfaceFactoryOld {
	...
	/**
	 * A convenience method to create an EnvironmentManager object directly out
	 * of specified LoginParams.
	 * 
	 * @param params
	 *            the login parameters
	 * @return the EnvironmentManager object
	 * @throws LoginException
	 *             if the login failed (most likely username & password are
	 *             wrong)
	 * @throws ServiceInterfaceException
	 *             if the serviceInterface could not be created
	 */
	public static EnvironmentManager login(LoginParams params)
	...
	/**
	 * Convenience method which creates an EnvironmentManager object out of a
	 * ServiceInterface.
	 * 
	 ...
	 * @throws LoginException
	 *             if the serviceInterface is null
	 */
	public static EnvironmentManager login(ServiceInterface serviceInterface)
			throws LoginException {
		...
		// } catch (Exception e) {
		// throw new
		// LoginException("Error when trying to logon to web service: "+e.getLocalizedMessage());
		// }
	...
	/**
	 * A convenience method to create an EnvironmentManager object out of the
	...
	public static EnvironmentManager login(String interfaceUrl,
		...
		ServiceInterface serviceInterface = createInterface(interfaceUrl,
				username, password, myProxyServer, myProxyPort, httpProxy,
				httpProxyPort, httpProxyUsername, httpProxyPassword);
