...
public interface SubmissionObject {
	...
	/**
	 * Sets the internal state of this SubmissionObject to point it to the
	 * specified {@link SubmissionLocationException}.
	 * 
	 * @param location
	 *            the locations
	 * @throws SubmissionLocationException
	 *             if the location is not valid (most likely because there is no
	 *             staging filesystem for it in the users' environment).
	 */
