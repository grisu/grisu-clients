 ...
 * 
 */
public class CommonWithMemory extends Common implements FqanListener,
		MountPointsListener, SubmissionObjectHolder {

	static final Logger myLogger = Logger.getLogger(Common.class.getName());

	public static final String[] MODULES_USED_MEMORY = new String[] {
	...
	public void initializeTemplateNodes(Map<String, TemplateNode> templateNodes) {
		...
		templateNodes.get(TemplateTagConstants.MIN_MEM_TAG_NAME)
				.setTemplateNodeValueSetter(memorySetter);
	...
	public void setMemory(long memoryinbytes) {
		...
		templateNodes.get(TemplateTagConstants.MIN_MEM_TAG_NAME)
				.getTemplateNodeValueSetter().setExternalSetValue(memory);
	}
}
