...
/**
 * This class is not really used on runtime. For each way of rendering a JsdlTemplate you would write your own
 * abstract module (see for example: {@link AbstractModulePanel} for Swing which copies the code from
 * this class into it's own class).
 * 
...
//	}
	 ...
	 */
	abstract public void initializeTemplateNodes(Map<String, TemplateNode> templateNodes);
	...
	public void checkWhetherAllTemplateNodesHaveSetter() throws TemplateException {
		for ( TemplateNode templateNode : templateNodes.values() ) {
			if ( templateNode.getTemplateNodeValueSetter() == null ) {
				throw new TemplateException("Module "+getModuleName()+" missing TemplateNodeValueSetter for templateNode: "+templateNode.getName());
			}
		}
	}
