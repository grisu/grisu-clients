...
/**
 * This is a very simple implementation of the {@link SubmissionObject} interface.
 * Basically it only holds the submissionlocation that gets set to give it back 
 * later.
 * 
 * It uses mds still for lookup of available submission locations, but it doesn't check whether the
 * application is available there. Neither is it able to get executable/modules information from 
 * mds. This information has to be set using the @link {@link #setModules(String[])} & {@link #setExecutables(String[])}
 * methods.
 * 
