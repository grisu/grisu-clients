...
public interface FileSystemBackend {
	 ...
	 * 
	 * @return true if the file exists. False if it doesn't exist or is not in
	 *         this filesystem.
	 */
	 ...
	 *            the filename
	 * @param refresh
	 *            whether to refresh the parent
	 * @return the child BackendFileObject or null if there is no file with that
	...
	/**
	 * Returns all the children of the specified file object. Does not refresh
	 * the folder beforehand.
	 * 
	 * @param folder
	 *            the folder
	 * @return an array of children BackendfileObject s or null if the folder is
	 *         not a ...folder
	 */
	public GrisuFileObject[] getChildren(GrisuFileObject folder);

	/**
	 * Returns all the children of the specified file object and lets the user
	 * specify whether he wants to refresh the parent folder beforehand.
	 * 
	 * @param folder
	 *            the folder
	 * @param refresh
	 *            whether to refresh the folder beforehand
	 * @return an array of children BackendfileObject s or null if the folder is
	 *         not a ...folder
	 */
	 ...
	 * 
	 * @param uri
	 *            the uri (which should be within this file system)
	 * @return the BackendFileObject or null if the uri is not within this file
	 *         system
	 */
	 ...
	 * @param file
	 *            the file
	 * @return the last modified date (in unix-time) or -1 if the date could not
	 *         be retrieved
	 */
	 ...
	 * 
	 * @param path
	 *            the path of the file either relative to the root folder (e.g.
	 *            folder/file) or absolute (gsiftp://blahblah/file)
	 * @param refresh
	 *            whether to check if a newer version exists remotely or not
	 * @return the local representation of this file
	 */
	...
	/**
	 * This one returns the root folder for the local representation of this
	 * file system. If the file system is local anyway it can just return the
	 * normal root folder. If it is remote it would return the root folder of
	 * the cache directory where the file system is (partially) mirrored.
	 * 
	 ...
	 * @param file
	 *            the file
	 * @return the relative path or null if this file is not within the
	 *         filesystem
	 */
	 ...
	 * 
	 * @return the name of the site or "Local" if Grisu thinks this file system
	 *         is on the local hard disk
	 * @throws InformationError
	 *             if no site can be found for this filesystem.
	 */
