...
public class MountPointEvent extends EventObject {
	...
	public MountPointEvent(Object source, int event_type, MountPoint mp, ServiceInterface serviceInterface) {
		super(source);
	...
	public MountPointEvent(Object source, MountPoint[] mps, ServiceInterface serviceInterface) {
		super(source);
