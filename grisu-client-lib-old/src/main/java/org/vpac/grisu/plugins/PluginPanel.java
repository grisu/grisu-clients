...
/**
 * Wrapper interface that provides the panel which is created via reflection whenever a class is found 
 * that follows this pattern: org.vpac.grisu.plugins.[applicationname].MainPanel
 * @author markus
 *
 */
