...
public class BlenderHelpers {
	...
	public static String createCommandline(int startFrame, int endFrame, String pathToInputFiles, String blenderFilename, String format, String outputFilename) {
		...
		"-b "+pathToInputFiles+"/"+blenderFilename +
		" -F " + format.toString() +
		" -o " + outputFilename +
